 ...
 *
 * 사용 방법:
 * 1. 인스턴스 생성: new pageList(Integer pagesPerBlock, Integer postsPerPage, Long totalPostCount)
...
public class PageList {
    ...
    public PageList(Integer pagesPerBlock, Integer postsPerPage, Long totalPostCount) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 인스턴스 생성
        PageList pageList= new PageList(PAGES_PER_BLOCK, POST_PER_PAGE, totalPostCount);

        try {
            for(int i = 1; i <= pageList.getTotalLastPageNum(); i++) {
                System.out.println(pageList.getElasticBlock(i));
            }
        } catch (Exception e) {
